                  ...
                  {canReview && (
                    <div className="absolute top-6 left-1/2 -translate-x-1/2 z-50 flex flex-col items-center gap-3" onMouseDown={(e) => e.stopPropagation()}>
                      <div className="bg-white/90 backdrop-blur-md p-1.5 rounded-2xl shadow-2xl shadow-black/10 border border-white flex gap-2">
                        ...
                        <button onClick={(e) => { e.stopPropagation(); setDrawTool('draw'); }} className={`flex items-center gap-2 px-5 py-3 rounded-xl transition-all font-black text-[10px] uppercase tracking-widest ${drawTool === 'draw' ? 'bg-blue-600 text-white shadow-lg ring-4 ring-blue-500/20' : 'bg-gray-50 text-gray-400 hover:bg-gray-100 hover:text-gray-900'}`}>
