...
// --- SUB-COMPONENT: INCELEME LISTESI ---
    ...
    <div className="mt-8 animate-fade-in">
      ...
      {sorular.length === 0 ? (
        ...
        <div className="grid gap-4">
          {sorular.map(soru => (
            <div key={soru.id} className="card bg-white p-4 rounded-lg border border-gray-100 flex justify-between items-center group">
              <div className="flex gap-4">
                <div className="space-y-2">
                  <div className="flex items-center space-x-2">
                    <span className="px-2 py-0.5 text-xs rounded-full font-bold bg-blue-100 text-blue-700 uppercase">
                      {['ÇOK KOLAY', 'KOLAY', 'ORTA', 'ZOR', 'ÇOK ZOR'][soru.zorluk_seviyesi - 1] || 'ZORLUK ' + soru.zorluk_seviyesi}
                    </span>
