...
export default function Layout() {
  ...
  if (effectiveRole === 'admin' || effectiveRole === 'soru_yazici') {
    menuItems.push(
      { path: '/sorular', label: 'Ortak Soru Havuzu', icon: 'M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10' },
      { path: '/brans-havuzu', label: 'Branş Havuzu', icon: 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253' }
    );
  }
          ...
          <div className="text-left">
            ...
            <div className="mt-1 flex flex-col gap-1">
              ...
              {effectiveRole === 'incelemeci' ? (
                <div className="text-[10px] text-green-400 font-bold uppercase flex items-center gap-1 mt-1">
